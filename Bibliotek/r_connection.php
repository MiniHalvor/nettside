...
$passiv = "0";
if ($count == 0) {
    $sql = "INSERT INTO `bruker` (`brukerid`, `fnavn`, `enavn`, `telefon`, `postnr`, `medlemSiden`, 
    `antallbok`, `gatenavn`, `gatenummer`, `passord`, `passordendring`, `epost`, `nyhetsbrev`, `admin`, `passiv`) 
          VALUES (NULL, '$fnavn', '$enavn', '$telefon', '$postnr', '$medlemSiden', '0', '$gatenavn',
           '$gatenummer', '$psw', '$passordendring', '$epost', '0', '0', '0');";
    ...
    echo "<div class=\"kontakt\">Det finnnes allerede en bruker som benytter seg av dette telefonnummeret. 
    Vennligst benytt deg av et annet telefonnummer når du registrerer deg eller ta kontakt med oss på 
    Epsilonbib@gmail.com dersom du mener at det er din bruker det er snakk om.</div>";
}
CloseCon($conn);
