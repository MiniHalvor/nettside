    ...
    <div id="master">
     <header class="header">
      ...
      <div id="content">
        ...
        <form action="r_connection.php" method="POST">
          <div class="container">
            <center>
              <p>Vennligst fyll ut dette skjemaet for å registrere deg</p>
            </center>
            <hr />
            ...
            <label for="gatenavn"><b>Gatenavn</b></label>
            <input
              type="text"
              placeholder="Apalveien"
              name="gatenavn"
              required
            />

            <label for="gatenummer"><b>Gatenummer</b></label>
            <input type="text" placeholder="111B" name="gatenummer" required />

            <label for="epost"><b>Epost</b></label>
            <input
              type="text"
              placeholder="Ola.nordmann@yahoo.com"
              name="epost"
              required
            />
            ...
            <p>
              Med å lage en bruker aksepterer du våre
