    ...
    <div id="master">
     <header class="header">
      ...
      <div id="content">
        ...
        if (isset($_SESSION["admin"]) && $_SESSION["admin"] === "0") {
          echo "<form action=\"spørsmål_connection.php\" method=\"POST\">\n";
          echo "              <div class=\"container\">\n";
          echo "                <hr />\n";
          echo "                <label for=\"spørsmål\"><b>Spørsmål</b></label>\n<br><br>";

          echo "<textarea name=\"spørsmål\" rows=\"10\" cols=\"137\" maxlength=\"300\" required></textarea>";
          echo "                <button type=\"submit\" class=\"registerbtn\">Send inn spørsmål</button>\n";
          echo "<p>Det tar som oftest noen dager før spørsmålet ditt blir besvart av en administrator</p>";
          echo "              </div> \n";
          echo "            </form>";
        } else {
          echo "<center><p>Vennligst logg inn for å sende inn spørsmål.</p></center>";
        }
        ?>
      </div>
     <div id="footer">
