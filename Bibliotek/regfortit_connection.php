      ...
      <div id="content">
        <div id="tittel"><h1>Registrer tittel</h1></div>
         ...
         $sql = "INSERT INTO `forfatter_has_tittel` (`forfatter_forfatterid`, `tittel_tittelid`) 
           VALUES ('$forfatter', '$tittel')";

         if ($conn->query($sql) === true) {
           echo '<center><div class="registrert">';
           echo "<h2>Gratulerer, koblingen mellom \"$tittelnavn\" og $forfatternavn har blitt registrert i vår database.</h2>";
           echo "<br><br><a href=\"regfortit.php\">Registrer nye koblinger</a>";
