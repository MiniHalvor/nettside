...
<html>
  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        <div id="tittel"><h1>Registrer tittel</h1></div>
         <?php if (isset($_SESSION["admin"]) && $_SESSION["admin"] === "1") {
           echo "<form action=\"regtit_connection.php\" method=\"POST\">\n";
           echo "              <div class=\"container\">\n";
           echo "                <hr />\n";
           echo "                <label for=\"tittel\"><b>Tittel</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Tittel\" name=\"tittel\" required />\n";
           echo "<label for=\"sjanger\">Velg en sjanger</label>\n";
           echo "  <select id=\"sjanger\" name=\"sjanger\">\n";

           include 'db_connection.php';
           $conn = OpenCon();
           $sql = "select * from sjanger";
           ...
           echo "               <br><br> <label for=\"utgivelsesår\"><b>Utgivelsesår</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"utgivelsesår\" name=\"utgivelsesår\" required />\n";

           echo "                <label for=\"Forlag\"><b>Forlag</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Forlag\" name=\"Forlag\" required />\n";

           echo "                <label for=\"Originaltittel\"><b>Originaltittel</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Originaltittel\" name=\"Originaltittel\" required />\n";
