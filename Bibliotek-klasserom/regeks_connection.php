  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        ...
        $tittel_tittelid = $_POST['tittel'];
        $språk = $_POST['språk'];
        $format = $_POST['format'];
        $sidetall = $_POST['sidetall'];
        $antall = $_POST['antall'];

        if ($antall == 5) {
          $sql = "INSERT INTO `bok` (`bokid`, `tittel_tittelid`, `språk`, `Format`, `Sidetall`) 
          VALUES 
          (NULL, '$tittel_tittelid', '$språk', '$format', '$sidetall'), 
          (NULL, '$tittel_tittelid', '$språk', '$format', '$sidetall'), 
          (NULL, '$tittel_tittelid', '$språk', '$format', '$sidetall'), 
          (NULL, '$tittel_tittelid', '$språk', '$format', '$sidetall'), 
          (NULL, '$tittel_tittelid', '$språk', '$format', '$sidetall')";
        ...
        if ($conn->query($sql) === true) {
          ...
          echo "<h2>Gratulerer, $antall bøker har blitt registrert i vår database.</h2>";
          echo "<br><br><a href=\"regeks.php\">Registrer nye eksemplarer</a>";
