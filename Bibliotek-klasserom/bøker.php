...
<html>
  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        <div id="tittel"><h1>Våre bøker</h1></div>
        <?php
        include 'db_connection.php';

        $conn = OpenCon();

        echo '<div id="søkefelt"> <form action="bokresultat.php" method="POST">   <input  type="text"  id="bøker" placeholder="Søk etter bøker"  name="Søk" required  /> <button type="submit">Søk</button></form></div>';

        $sql = "SELECT * FROM tittel, sjanger, forfatter_has_tittel, forfatter 
       WHERE forfatter.forfatterid=forfatter_has_tittel.forfatter_forfatterid 
       AND tittel.sjanger_sjangerid=sjanger.sjangerid 
       AND tittel.tittelid=forfatter_has_tittel.tittel_tittelid";
