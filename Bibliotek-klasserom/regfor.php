      ...
      <div id="content">
        <div id="tittel"><h1>Registrer forfatter</h1></div>
         <?php if (isset($_SESSION["admin"]) && $_SESSION["admin"] === "1") {
           echo "<form action=\"regfor_connection.php\" method=\"POST\">\n";
           echo "              <div class=\"container\">\n";
           echo "                <hr />\n";
           echo "                <label for=\"fnavn\"><b>Fornavn</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Fornavn\" name=\"fnavn\" required />\n";
           echo "\n";
           echo "                <label for=\"enavn\"><b>Etternavn</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Etternavn\" name=\"enavn\" required />\n";
           echo "                \n";
