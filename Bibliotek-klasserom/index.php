...
<html>
  ...
  <body>
    <div id="master">
      <header class="header">
        ...
        <ul class="main-nav">
           ...
           if (isset($_SESSION["admin"]) && $_SESSION["admin"] === "1") {
             echo '<li><a href="lever.php">Lever bøker</a></li>';
      ...
      <div id="forside">
       <img src="bilder/forside.jpg" alt="bilde av bok og briller"> 
             <div id="tittelf">
               <h1><b>Velkommen til Epsilon</b></h1>
              <p>Hele Norges bibliotek </p>
              </div>
      </div>
      <div id="footer">
