...
<html>
  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        <div id="tittel"><h1>Velkommen til Epsilon</h1></div>
        ...
        <div class="epsilonbilde">
          <img src="bilder/epsilon.png" alt="Bilde av epsilon"  >
        </div>
        <div class="row-container">
          <hr class="linje" />
          <p>Dette skjer på biblioteker rundt om i landet</p>
          <div class="row">
            <div class="nyhet">
              <a
                href="https://www.ostlendingen.no/fylkesbiblioteket-gar-digitalt-stengte-bibliotek-er-et-demokratisk-problem/s/5-69-920391"
                >Digitalt bibliotek</a
              >
            </div>
            <div class="nyhet">
              <a
      ...
      <div id="footer">
        <div id="footer-container">
          ...
          <div id="socials">
            ...
            <a href="https://www.youtube.com" class="fa fa-youtube fa-3x"></a>
          </div>
        </div>
      </div>
    </div>
