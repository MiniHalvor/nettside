  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        ...
        echo '<div id="søkefelt"> <form action="#" method="POST">   <input  type="text"  id="bøker" placeholder="Søk etter bøker"  name="Søk" required  /> <button type="submit">Søk</button></form></div>';
        $bok = $_POST['Søk'];
