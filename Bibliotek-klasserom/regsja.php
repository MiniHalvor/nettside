...
<html>
  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        <div id="tittel"><h1>Registrer sjanger</h1></div>
         <?php if (isset($_SESSION["admin"]) && $_SESSION["admin"] === "1") {
           echo "<form action=\"regsja_connection.php\" method=\"POST\">\n";
           echo "              <div class=\"container\">\n";
           echo "                <hr />\n";
           echo "                <label for=\"sjanger\"><b>Sjanger</b></label>\n";
           echo "                <input type=\"text\" placeholder=\"Sjanger\" name=\"sjanger\" required />\n";
