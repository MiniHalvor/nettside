  ...
  <body>
    <div id="master">
      ...
      <div id="content">
        ...
        $utgivelsesår = $_POST['utgivelsesår'];
        $forlag = $_POST['Forlag'];
        $originaltittel = $_POST['Originaltittel'];

        $sql = "INSERT INTO `tittel` (`tittelid`, `tittel`, `sjanger_sjangerid`,`utgivelsesår`,`Forlag`,`Originaltittel` ) 
        VALUES (NULL, '$tittel', '$sjanger', '$utgivelsesår', '$forlag', '$originaltittel' )";

          

        if ($conn->query($sql) === true) {
          echo '<center><div class="registrert">';
          echo "<h2>Gratulerer, \"$tittel\" har blitt registrert i vår database.</h2>";
          echo "<br><br><a href=\"regtit.php\">Registrer ny tittel</a>";
